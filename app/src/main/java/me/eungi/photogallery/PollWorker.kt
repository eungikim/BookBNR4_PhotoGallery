...
class PollWorker(private val context: Context, workerParams: WorkerParameters) : Worker(context, workerParams){
    ...
    override fun doWork(): Result {
        ...
        if (resultId == lastResultId) {
            ...
            val notification = NotificationCompat.Builder(context, NOTIFICATION_CHANNEL_ID)
                .setTicker(resources.getString(R.string.new_prictures_title))
                .setSmallIcon(android.R.drawable.ic_menu_report_image)
                .setContentTitle(resources.getString(R.string.new_prictures_title))
    ...
    companion object {
        const val ACTION_SHOW_NOTIFICATION =
            "me.eungi.photogallery.ACTION_SHOW_NOTIFICATION"
        const val PERM_PRIVATE = "me.eungi.photogallery.PRIVATE"
    }
